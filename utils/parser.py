...
def parse_args():
    parser = argparse.ArgumentParser(description="RAGM")

    # ===== dataset ===== #
    parser.add_argument("--dataset", nargs="?", default="doubanM", help="Choose a dataset:[ml1m,doubanM,yelp]")
    parser.add_argument(
    ...
    parser.add_argument("--n_factors", type=int, default=3, help="number of latent factor for user favour")
    ...
    parser.add_argument('--alpha', type=float, default=0.5, help='user representation ratio')
